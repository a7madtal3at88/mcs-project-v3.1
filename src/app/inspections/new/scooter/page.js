...
export default function ScooterInspection() {
  ...
  // ✅ Required fields (مش هنسمح بالـ Preview غير لما البيانات الأساسية تبقى متسجلة)
  ...
  function onSubmit(e) {
    ...
    if (!canSubmit) {
      ...
      if (firstMissing) {
        ...
        if (el && typeof el.scrollIntoView === "function") {
          ...
          // delay helps focus after scroll on some browsers/iPad
    ...
    localStorage.setItem("draft_scooter_inspection", JSON.stringify(payload));
    router.push("/inspections/new/scooter/preview");
  }
  ...
  return (
    <main style={{ padding: 24, fontFamily: "system-ui", maxWidth: 1150, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
        <div>
          <h1 style={{ margin: 0 }}>Scooter Inspection</h1>
      ...
      <form onSubmit={onSubmit} style={{ marginTop: 18, display: "grid", gap: 16 }}>
        ...
        <section style={section}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
            <DamageMap title="Left / اليسار" imageSrc="/bike/scooter/scooterleft.png" points={damageLeft} onChange={setDamageLeft} />
            <DamageMap title="Right / اليمين" imageSrc="/bike/scooter/scooterright.png" points={damageRight} onChange={setDamageRight} />
            <DamageMap title="Front / الأمام" imageSrc="/bike/scooter/scooterfront.png" points={damageFront} onChange={setDamageFront} />
            <DamageMap title="Back / الخلف" imageSrc="/bike/scooter/scooterback.png" points={damageBack} onChange={setDamageBack} />
            <DamageMap title="Top / أعلى" imageSrc="/bike/scooter/scootertop.png" points={damageTop} onChange={setDamageTop} />
          </div>
        </section>
        ...
        <SectionTable
          ...
          groups={[
            ...
            {
              groupId: "fairing_covers",
              groupEn: "Fairing Covers",
              groupAr: "غطاءات الفايبر",
              items: [
                { itemId: "front_cowl", itemEn: "Front Cowl", itemAr: "قشرة أمامية" },
                { itemId: "right_side_cover", itemEn: "Right Side Cover", itemAr: "قشرة يمين" },
                { itemId: "left_side_cover", itemEn: "Left Side Cover", itemAr: "قشرة شمال" },
                { itemId: "under_seat_cover", itemEn: "Under Seat Cover", itemAr: "قشرة تحت كرسي" },
                { itemId: "rear_cowl", itemEn: "Rear Cowl", itemAr: "قشرة خلفية" },
              ],
            },
            {
              groupId: "paint",
              groupEn: "Paint / Condition",
              groupAr: "الدهان / الحالة",
              items: [{ itemId: "paint_condition", itemEn: "Paint Condition", itemAr: "حالة الدهان" }],
            },
          ]}
          notes={panelsNotes}
